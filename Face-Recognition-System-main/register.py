...
class Register:
	def __init__(self, root):
		...
		#=======Bg Image====
		self.bg=ImageTk.PhotoImage(file=r"C:\Users\DELL\Desktop\Face-Recognition-System-main\img\regLeft.jpg")

		lbl_bg=Label(self.root,image=self.bg)
		lbl_bg.place(x=0,y=0,relwidth=1,relheight=1) 

		#====left image=====
		self.bg1=ImageTk.PhotoImage(file=r"C:\Users\DELL\Desktop\Face-Recognition-System-main\img\regLeft.jpg")
	...
	def register_data(self):
		if self.var_fname.get()=="" or self.var_email.get()=="" or self.var_securityQ.get()=="Select":
			...
			conn=mysql.connector.connect(host="localhost",username="root",password="primmie0910",database="signup_admin")
