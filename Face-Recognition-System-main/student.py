...
class Student:
    def __init__(self, root):
        ...
        title_lbl = Label(text="STUDENT DETAILS", font=("Sketchy In Snow", 40, "bold"),
                          bg="purple", fg="white")
        ...
        img_left = Image.open(r"C:\Users\DELL\Desktop\Face-Recognition-System-main\img\stdnt.jpg")

        img_left = img_left.resize((720, 130), Image.ANTIALIAS)
        self.photoimg_left = ImageTk.PhotoImage(img_left)

        f_lbl = Label(Left_frame, image=self.photoimg_left)
        f_lbl.place(x=5, y=0, width=720, height=1)

        # current course
        Current_course_frame = LabelFrame(Left_frame, bd=2, bg="white", relief=RIDGE, text="Current Course Information",
                                          font=("times new roman", 12, "bold"))
        Current_course_frame.place(x=5, y=10, width=720, height=100)
        ...
        dep_combo = ttk.Combobox(Current_course_frame, textvariable=self.var_dep, font=("times new roman", 12, "bold"),
                                 state="readonly")
        dep_combo["values"] = ("Select Department", "CoE", "CICT", "CCJ", "CET", "CHTM", "CBM", "CAS")
        dep_combo.current(0)
        ...
        student_div_label = Label(Class_student_frame, text="Class Division:", font=("times new roman", 12, "bold"),
                                  bg="white")
        ...
        div_combo["values"] = (" ","A", "B", "C","D","E","F","G","H")
        div_combo.current(0)
        ...
        studentReg_entry = ttk.Entry(Class_student_frame, textvariable=self.var_reg, width=20,
                                     font=("times new roman", 12, "bold"))
        ...
        gender_combo["values"] = (" ","Male", "Female", "Prefer not to Answer")
        ...
        update_btn = Button(btn_frame, text="Update", command=self.update_data, width=19,
                            font=("times new roman", 12, "bold"), bg="purple", fg="white")
        ...
        take_photo_btn = Button(btn_frame1, command=self.generate_dataset, text="Take Photo Sample", width=40,
                                font=("times new roman", 12, "bold"), bg="purple", fg="white")
        take_photo_btn.grid(row=0, column=0)

        update_photo_btn = Button(btn_frame1, text="Update Photo Sample", width=40,
                                  font=("times new roman", 12, "bold"), bg="purple", fg="white")
        ...
        # image section
        img_right = Image.open(r"C:\Users\DELL\Desktop\Face-Recognition-System-main\img\group cls 02.jpg")

        img_right = img_right.resize((720, 130), Image.ANTIALIAS)
        self.photoimg_right = ImageTk.PhotoImage(img_right)

        f_lbl2 = Label(Right_frame, image=self.photoimg_right)
        f_lbl2.place(x=5, y=0, width=720, height=1)

        # search system
        search_frame = LabelFrame(Right_frame, bd=2, bg="white", relief=RIDGE, text="Search",
                                  font=("times new roman", 12, "bold"))
        search_frame.place(x=5, y=50, width=550, height=70)
        ...
        search_entry = ttk.Entry(search_frame, textvariable=self.search_txt, width=15,
                                 font=("times new roman", 12, "bold"))
        ...
        showAll = Button(search_frame, text="Show All", command=self.fetch_data, width=12,
                         font=("times new roman", 12, "bold"), bg="violet", fg="white")
        showAll.grid(row=0, column=4, padx=4)

        # table frame

        table_frame = Frame(Right_frame, bd=2, bg="white", relief=RIDGE)
        table_frame.place(x=5, y=125, width=650, height=70)

        scroll_x = ttk.Scrollbar(table_frame, orient=HORIZONTAL)
        scroll_y = ttk.Scrollbar(table_frame, orient=VERTICAL)

        self.student_table = ttk.Treeview(table_frame, column=(
        "dep", "course", "year", "sem", "id", "name", "div", "reg", "gender", "dob", "email", "phone", "address",
    ...
    def add_data(self):
        if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "" or self.var_std_id.get() == "":
            ...
            try:
                ...
                mydb = mysql.connector.connect(host="localhost", username="root", password="primmie0910", database="tcu_cict_cnn")
    ...
    # =====fetching data from database for showing on display board====
    def fetch_data(self):
        mydb = mysql.connector.connect(host="localhost", username="root", password="primmie0910", database="tcu_cict_cnn")
        mycursor = mydb.cursor()
        ...
        if len(data) != 0:
            ...
            mydb.commit()  # for keep updating data
        mydb.close()
        ...
        if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "" or self.var_std_id.get() == "":
            ...
            try:
                ...
                if Update > 0:
                    ...
                    mycursor = mydb.cursor()
                    mycursor.execute(
                        "update student set Dep=%s,course=%s,Year=%s,Semester=%s,Name=%s,Division=%s,Reg=%s,Gender=%s,Dob=%s,Email=%s,Phone=%s,Address=%s,Teacher=%s,PhotoSample=%s where Student_id=%s",
                        (
                            self.var_dep.get(),
                            self.var_course.get(),
                            self.var_year.get(),
